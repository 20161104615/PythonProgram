...
class QQmusic:
    ...
    def getSongmid(self):
        ...
        for song in songlist:
            ...
            name = song['songname']
            self.sl.append((name,songmid,albumid))
            print('获取成功songmid')
    ...
    def downloadMusic(self):
        ...
        for songimg in self.sl:
            ...
            urllib.request.urlretrieve(imgurl,os.path.join(path,list(songimg)[0]+'.jpg'))
